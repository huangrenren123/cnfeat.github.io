...
//			        alert("加载完成");
		   ...
		   var $btn1=$("#btn1");
			...
			var scroll = new BScroll($wrapper, {
				    ...
				    momentum:false,
				    tap:true,
				    preventDefaultException:{className:/(^|\s)erweima(\s|$)/}
...
//				    }
		   ...
		   scroll.on("beforeScrollStart",function(){
		    ...
		    scroll.on('scroll', function (pos) {
				...
				oldY = y;
				$man1.css({"transform":"translate3d("+dot.x+"rem,"+dot.y+"rem,0)"});
				$man1.css({"-moz-transform":"translate3d("+dot.x+"rem,"+dot.y+"rem,0)"});
				$man1.css({"-ms-transform":"translate3d("+dot.x+"rem,"+dot.y+"rem,0)"});
				$man1.css({"-webkit-transform":"translate3d("+dot.x+"rem,"+dot.y+"rem,0)"});
				$man1.css({"-o-transform":"translate3d("+dot.x+"rem,"+dot.y+"rem,0)"});
			})
